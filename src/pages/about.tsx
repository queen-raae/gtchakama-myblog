...
<section className="dark:bg-coolGray-800 dark:text-coolGray-100">
	<div className="container p-6 mx-auto space-y-6 text-center lg:p-8 lg:space-y-8">
		<h2 className="text-3xl font-bold">Some of the Tools I use</h2>
		<div className="flex flex-wrap justify-center lg:justify-between">
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-label="Angular" className="w-12 h-12 mx-10 my-6 fillCurrent md:mx-12 lg:m-0 dark:text-coolGray-400">
				<title>Angular</title>
			...
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-label="Gatsby" className="w-12 h-12 mx-10 my-6 fillCurrent md:mx-12 lg:m-0 dark:text-coolGray-400">
				<title>Gatsby</title>
			...
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-label="Plain HTML" className="w-12 h-12 mx-10 my-6 fillCurrent md:mx-12 lg:m-0 dark:text-coolGray-400">
			...
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-label="Next.js" className="w-12 h-12 mx-10 my-6 fillCurrent md:mx-12 lg:m-0 dark:text-coolGray-400">
				<title>Next.js</title>
			...
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-label="Nuxt.js" className="w-12 h-12 mx-10 my-6 fillCurrent md:mx-12 lg:m-0 dark:text-coolGray-400">
				<title>Nuxt.js</title>
			...
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-label="React" className="w-12 h-12 mx-10 my-6 fillCurrent md:mx-12 lg:m-0 dark:text-coolGray-400">
				<title>React</title>
			...
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-label="Svelte" className="w-12 h-12 mx-10 my-6 fillCurrent md:mx-12 lg:m-0 dark:text-coolGray-400">
				<title>Svelte</title>
			...
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-label="Vue.js" className="w-12 h-12 mx-10 my-6 fillCurrent md:mx-12 lg:m-0 dark:text-coolGray-400">
				<title>Vue.js</title>
...
<ul className="p-4 lg:p-8 dark:bg-coolGray-800 dark:text-coolGray-100">
	<li>
		<article>
